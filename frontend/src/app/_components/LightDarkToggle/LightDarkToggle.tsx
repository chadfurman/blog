        ...
        <svg viewBox="0 0 69.667 44" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
          <g transform="translate(3.5 3.5)" data-name="Component 15 – 1" id="Component_15_1">
            ...
            <g filter="url(#container)" transform="matrix(1, 0, 0, 1, -3.5, -3.5)">
              <rect fill="#83cbd8" className="container-rect" transform="translate(3.5 3.5)" rx="17.5" height="35"
                    width="60.667"
                    data-name="container" id="container"></rect>
            </g>

            <g transform="translate(2.333 2.333)" id="button" className="button">

              <g data-name="sun" id="sun" className="sun">
            ...
            <g filter="url(#cloud)" transform="matrix(1, 0, 0, 1, -3.5, -3.5)">
              <path fill="#fff" transform="translate(-3466.47 -160.94)"
                    ...
                    data-name="cloud" id="cloud" className="cloud"></path>
            </g>


            <g fill="#def8ff" transform="translate(3.585 1.325)" id="stars" className="stars">
